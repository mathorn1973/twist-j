...
def concise_run_checked(*args: str) -> str:
    ...
    # The temporary builder was authored against an older diagnostic phrase.
    # Current generate_canon_views.py reports `CANON VIEWS APPLIED ...`.
    # Normalize only the returned diagnostic string, never generated bytes.
