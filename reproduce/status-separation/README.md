...
deterministic text. Its nineteen checks cover the current registry partition,
...
decoder data, and physical readings, the
...
Expected: byte-identical output to `EXPECTED.txt`, `RESULT 19/19 ALL PASS`,
