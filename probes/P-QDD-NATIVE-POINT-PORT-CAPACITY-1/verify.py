#!/usr/bin/env python3
"""Exact L1 audit for P-QDD-NATIVE-POINT-PORT-CAPACITY-1.
Adapted from A. M. Thorn's Apache-2.0 issue #1036 audit.py, Git blob
3e48205d4649118006377f559b9423950a6d97d7. See SOURCE.md for accepted custody.
Exposed census, bounds and constructive certificates are frozen assertions.
The companion preregistration-only breaker is pinned and replayed with this
verifier; no all-time or physical statement is inferred from finite history.
"""
...
def main():
    ...
    out = {
        'probe': 'P-QDD-NATIVE-POINT-PORT-CAPACITY-1',
    ...
    out['independent_prereg_breaker'] = BREAKER.check()
