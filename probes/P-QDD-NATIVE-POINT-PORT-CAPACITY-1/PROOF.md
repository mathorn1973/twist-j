...
**PROSPECTIVE, RESULT-EXPOSED proof. Public status is decided separately.**
...
adjacent preregistration are part of the statements below.
...
The frozen exact census certificate is:
...
The verifier compares direct point enumeration, the 69-pattern
...
into sizes `124,125,125,125,125`. The finite certificate gives the following
...
Before this preregistration/code pin, no new formal verifier was executed. No physical apparatus
