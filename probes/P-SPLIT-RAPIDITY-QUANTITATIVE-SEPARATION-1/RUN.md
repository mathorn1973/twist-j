...
This initial record intentionally has no structured `Required GitHub leg`.
The pull request check must reproduce the pin on the complementary required
architecture before the two-architecture evidence is complete.
