#!/usr/bin/env python3
"""Adversarial exact checks for P-J-NORM-TRACE-TANGENT-SEAM-1.

Same-session breaker, pinned before the formal verify.py execution.  This is
not independent confirmation and is not a second-architecture gate.
"""
