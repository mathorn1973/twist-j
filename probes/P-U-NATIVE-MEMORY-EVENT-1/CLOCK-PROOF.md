# P-U-NATIVE-MEMORY-EVENT-1: exact clock and atom frequencies
...
review and any later Canon fold remain separate. No physical measure is
adopted. The formal verifier audits the finite identities, while its own
EXPECTED.txt and RUN.md record the resulting execution provenance. No finite
sample is the logical basis of the limiting-frequency theorem below.
