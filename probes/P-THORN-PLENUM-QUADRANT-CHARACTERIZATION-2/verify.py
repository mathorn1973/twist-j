#!/usr/bin/env python3
"""Exact audit for P-THORN-PLENUM-QUADRANT-CHARACTERIZATION-2.
...
def source_firewall() -> bool:
    ...
    required = (
        ...
        "Status: ABANDONED.",
        "G12 contiguous-string/newline defect",
...
def main() -> int:
    ...
    gate(
        ...
        and "No selector, physical mechanism, or preferred embedding"
            in normalized_prereg
