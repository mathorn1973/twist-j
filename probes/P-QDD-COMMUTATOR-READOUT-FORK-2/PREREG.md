# P-QDD-COMMUTATOR-READOUT-FORK-2 preregistration

Date: 2026-08-21. Author: A. M. Thorn. Public lock: issue 493.
...
Issue 492 and `P-QDD-COMMUTATOR-READOUT-FORK-1` are permanently closed with
`STOP / PRE-PIN ACCEPTED-VERIFIER DRY EXECUTION / NO SCIENTIFIC CONCLUSION`;
formal executions after its public pin: zero. Nothing from that lane is amended,
rerun, renamed or used as evidence. This successor has fresh identifiers and
source bytes.
...
Accepted file: `probes/P-QDD-COMMUTATOR-READOUT-FORK-2/verify.py`.
