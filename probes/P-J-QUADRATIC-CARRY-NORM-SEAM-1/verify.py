#!/usr/bin/env python3
"""Exact audit for P-J-QUADRATIC-CARRY-NORM-SEAM-1.
...
def main():
    ...
    # Difference for A=1/2 is c0 + c1*sqrt5 + c2*B + ...;
    # exact hand expansion reduces to (5/4)(1-4B^2).
    # Audit at the polynomial coefficient level in B: const=5/4, linear=0, quadratic=-5.
    factor_coeffs = (F(5,4), F(0), F(-5))
    check("G4 multiplicativity factor", factor_coeffs == (F(5,4), F(0), F(-5)),
    ...
    print("TWIST-J P-J-QUADRATIC-CARRY-NORM-SEAM-1")
