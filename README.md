...
**State: ACTIVE. Public Canon v11 is the normative public ledger.** Authority is
the public `main` branch at the tag `canon-v11`; see [STATUS.md](STATUS.md) and
...
- [Canon](canon/CANON.md): the normative Public Canon v11 text.
...
`11`, tagged `canon-v11`; versions `1`, `2`, `3`, `4`, `5`, `6`, `7`, `8`, `9`,
and `10` remain immutable preceding releases. A later normative replacement is
version `12`, then version `13`, and so on.
