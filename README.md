...
**State: ACTIVE. Public Canon v6 is the normative public ledger.** Authority is
the public `main` branch at the tag `canon-v6`; see [STATUS.md](STATUS.md) and
...
- [Canon](canon/CANON.md): the normative Public Canon v6 text.
...
`6`, tagged `canon-v6`; versions `1`, `2`, `3`, `4`, and `5` remain immutable
preceding releases. A later normative replacement is version `7`, then version
`8`, and so on.
