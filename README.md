...
**State: ACTIVE. Public Canon v67 is the normative public ledger.** Authority is
the public `main` branch at the tag `canon-v67`; see [STATUS.md](STATUS.md) and
...
- [Canon](canon/CANON.md): the normative Public Canon v67 text.
...
The current release is Public Canon v67, tagged `canon-v67`.
