...
**State: ACTIVE. Public Canon v5 is the normative public ledger.** Authority is
the public `main` branch at the tag `canon-v5`; see [STATUS.md](STATUS.md) and
...
- [Canon](canon/CANON.md): the normative Public Canon v5 text.
...
`5`, tagged `canon-v5`; versions `1`, `2`, `3`, and `4` remain immutable
preceding releases. A later normative replacement is version `6`, then version
`7`, and so on.
