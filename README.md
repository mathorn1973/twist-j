...
**State: ACTIVE. Public Canon v86 is the normative public ledger.** Authority is
the public `main` branch at the tag `canon-v86`; see [STATUS.md](STATUS.md) and
...
- [Canon](canon/CANON.md): the normative Public Canon v86 text.
...
The current release is Public Canon v86, tagged `canon-v86`.
