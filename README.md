...
**State: ACTIVE. Public Canon v47 is the normative public ledger.** Authority is
the public `main` branch at the tag `canon-v47`; see [STATUS.md](STATUS.md) and
...
- [Canon](canon/CANON.md): the normative Public Canon v47 text.
...
The current release is Public Canon v47, tagged `canon-v47`.
