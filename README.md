...
**State: ACTIVE. Public Canon v3 is the normative public ledger.** Authority is
the public `main` branch at the tag `canon-v3`; see [STATUS.md](STATUS.md) and
...
- [Canon](canon/CANON.md): the normative Public Canon v3 text.
...
`3`, tagged `canon-v3`; versions `1` and `2` remain immutable preceding releases.
A later normative replacement is version `4`, then version `5`, and so on.
