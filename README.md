...
**State: ACTIVE. Public Canon v64 is the normative public ledger.** Authority is
the public `main` branch at the tag `canon-v64`; see [STATUS.md](STATUS.md) and
...
- [Canon](canon/CANON.md): the normative Public Canon v64 text.
...
The current release is Public Canon v64, tagged `canon-v64`.
