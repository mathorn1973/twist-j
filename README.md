...
**State: ACTIVE. Public Canon v58 is the normative public ledger.** Authority is
the public `main` branch at the tag `canon-v58`; see [STATUS.md](STATUS.md) and
...
- [Canon](canon/CANON.md): the normative Public Canon v58 text.
...
The current release is Public Canon v58, tagged `canon-v58`.
