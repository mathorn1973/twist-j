...
**State: ACTIVE. Public Canon v39 is the normative public ledger.** Authority is
the public `main` branch at the tag `canon-v39`; see [STATUS.md](STATUS.md) and
...
- [Canon](canon/CANON.md): the normative Public Canon v39 text.
...
The current release is Public Canon v39, tagged `canon-v39`.
