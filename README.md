...
**State: ACTIVE. Public Canon v4 is the normative public ledger.** Authority is
the public `main` branch at the tag `canon-v4`; see [STATUS.md](STATUS.md) and
...
- [Canon](canon/CANON.md): the normative Public Canon v4 text.
...
`4`, tagged `canon-v4`; versions `1`, `2`, and `3` remain immutable preceding
releases. A later normative replacement is version `5`, then version `6`, and so on.
