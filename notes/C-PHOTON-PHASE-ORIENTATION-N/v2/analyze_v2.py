#!/usr/bin/env python3
"""Analysis and frozen decision rule for C-PHOTON-PHASE-ORIENTATION-N v2.
...
def main():
    ...
    labels = {}
    thr = 4 * math.sin(math.pi / 24) ** 2 / 4
    print(f"ANALYSIS C-PHOTON-PHASE-ORIENTATION-N v2 set={modelset} block={BLOCK} q2min/4={thr:.6f}")
    ...
    if modelset == "A2":
        ...
        print("ENGINE_CALIBRATION_V2 " + ("PASS" if ok else "FAIL"))
    else:
