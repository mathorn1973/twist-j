...
# ------------------------------------------------------------------ 5. status-separation release witness (updated by every fold)
...
for tool in ("check_ledger.py", "check_canon.py", "check_status_labels.py"):
    ...
    print(f"[{tool}] " + (out.splitlines()[-1] if out else "(no output)"))
