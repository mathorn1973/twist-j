...
v48_sentence = (
    ...
    "projector pair and the slot boundary. The new QDD-DIRECT-FIREWALL check "
    "computes the transitive closure of DEF-QDD-DIRECT-WRITE in "
    "canon/DEPENDENCIES.tsv and requires it to be exactly the domain, the "
    "balanced piston, the amplitude, the coefficient data, the trace pairing, "
    "the LOW LINE and the record schema, with no factor-side object."
)
rw(ROOT / "reproduce" / "status-separation" / "README.md", [
    ("Its thirty-two checks cover the current", "Its thirty-four checks cover the current"),
