# PREREG: C-PHOTON-REPLICA-COMPLETION-BOUND-N2
...
License: Apache-2.0
Owner issue: #1165
Branch: `notes/photon-replica-completion2-20260926`
...
## 1A. Consumed predecessor and the sole repair

The predecessor #1164 is consumed by its failed first audit at pin
\`b98c4a8710b641e20f05b33de612d776d02a707c\`. Its scientific assertions are
not inherited as computed results. The failure was an inconsistent auxiliary
gluing fixture, not a fired mathematical falsifier.

This successor changes one verifier fixture only. For amplitudes
\`(1,1,2,2)\`, the second auxiliary edge is replaced by the frozen admissible
pair
...
Their exact solution conditions are \`x1=-x0\` and \`x3=-x2\`. The scientific
scope, local projector, exterior-completion law, route threshold, all other
fixtures and every interpretation boundary remain unchanged.
