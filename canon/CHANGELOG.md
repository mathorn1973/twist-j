...
nineteen sections; 130 registered claims (66 theorem grade, of which 61
carry minimal reproductions and 5 carry inline derivations; 20 derived
...
sibling),
carried by the same witnesses as their theorem layers; 9 computed grade, the
kernel census cluster, the alpha value digits, the boundary
hyperplane realization, the kernel component census, the time
quantum tower, and the silver ring facts, carried by
...
at their registered scopes; 32 live frontier rows,
each with a concrete falsifier or a decision condition stating what
closes it positively and what closes it negatively); seventeen
